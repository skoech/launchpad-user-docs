...
html_title = project + " user documentation"
...
html_favicon = '.sphinx/_static/favicon.svg'
...
html_context = {
    ...
    "product_page": "https://launchpad.net/",
    ...
    "mattermost": "https://chat.canonical.com/canonical/channels/launchpad",
